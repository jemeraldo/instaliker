...
from .bot_get import get_media_owner, get_your_medias, get_user_medias, get_total_geotag_medias
...
class Bot(API):
    ...
    def get_total_geotag_medias(self, geotag, filtration=True):
        return get_total_geotag_medias(self, geotag, filtration)
